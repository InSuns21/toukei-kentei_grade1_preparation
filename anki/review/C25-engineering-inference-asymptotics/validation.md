...
validated 1278 cards (0 warnings)
built 1278 cards in 25 category page(s), max 200 per page
checked 1278 cards in 25 category page(s), max 200 per page
...
368 個の Markdown ファイルを KaTeX strict で検証しました。
