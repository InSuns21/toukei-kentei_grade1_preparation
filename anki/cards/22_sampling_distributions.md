...
---
## 問題
密度 $f$、累積分布関数 $F$ の連続分布からの標本の第 $p$ 分位点の標本量 $\widehat q_p$ について、$n$ が大きいときの漸近分布を答えよ。
...
## 注意
$\nu$ は整数である必要がなく、$n_1+n_2-2$ 以下になりやすい保守的な設計。
