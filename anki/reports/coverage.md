...
| 種々の確率分布 | 110 | 3/3 | theorem, calc_step, expansion, recognition |
...
| 離散型分布 | ポアソン分布 | card | dist-poisson-definition, dist-poisson-moments, dist-poisson-ratio-mode, dist-poisson-splitting, dist-poisson-moments-by-definition |
...
| 連続型分布 | ガンマ分布 | card | dist-gamma-recognition, dist-gamma-definition, dist-gamma-moments, dist-gamma-sum-exponential, dist-gamma-moments-by-definition |
| 連続型分布 | ベータ分布 | card | dist-beta-definition, dist-beta-moments, dist-beta-moments-by-definition |
