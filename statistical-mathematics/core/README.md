...
| 02 | 70 | S | S | [Bernoulliモデルで尤度比検定・ワルド・Scoreを比較する](70_bernoulli_lrt_wald_score.md) |
...
| 12 | 75 | S | A | [回帰係数の最尤推定量・Fisher情報・検定・検出力](75_regression_mle_fisher_power.md) |
...
| 18 | 57 | S | A | [逆分散重み付き推定・最良線形不偏推定量・最尤推定量・Cramér–Rao下限](57_inverse_variance_blue_mle.md) |
...
| 22 | 49 | S | A | [ポアソン最尤推定量・Fisher情報・信頼区間](49_poisson_mle_fisher_ci.md) |
...
| 27 | 3 | S | A | [ポアソン–Gamma混合・負の二項](03_poisson_gamma_mixture.md) |
...
| 43 | 53 | A | B | [Poisson母数推定：不偏性・一致性・平均二乗誤差](53_poisson_unbiased_consistent_mse.md) |
