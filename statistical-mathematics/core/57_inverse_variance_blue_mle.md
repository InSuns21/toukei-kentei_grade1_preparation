...
4. $(\sigma_1^2,\sigma_2^2,\sigma_3^2)=(1,4,9)$ のとき重みと分散を求め、Cramér–Rao下限と一致することを、Fisher情報量の導出と定理の適用条件も含めて確認せよ。
...
- Fisher情報量の導出・Cramér–Rao条件確認・数値例: 6点
