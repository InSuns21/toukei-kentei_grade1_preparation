# Core 26 ガンマ–Beta関係・Jacobian・独立
...
ここで $t$ の部分をガンマ$(a+b,1)$ の密度に合わせるため、$\Gamma(a+b)$ を掛けて割る。
...
第1因子はガンマ$(a+b,1)$ 密度で積分1。したがって第2因子も積分1であり
...
- 逆変換・支持・Jacobian: 5点
- ガンマ密度から同時密度を変数変換で導く: 6点
- 積への分解、Beta–ガンマ恒等式、周辺分布・独立性: 6点
- $E[U]$ とガンマ漸化式: 3点
