...
> (\varphi^*-\varphi)(f_1-kf_0)\ge0
> $$
> を作って積分する。この1行の符号の意味が分かれば、Neyman–Pearson補題の証明全体を追いやすい。
...
> Neyman–Pearson 補題を各対立点に適用しても、最強力な棄却域の向きが変わらない
...
### 混同1：「Neyman–Pearson補題が一様最強力検定を直接与える」
