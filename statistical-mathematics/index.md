...
| ---: | ---: | :---: | :---: | --- | --- |
| 01 | 40 | S | A | [Fisher情報量・Delta法・MLEの漸近効率](core/40_fisher_information_delta_mle_efficiency.md) | ◎ |
| 02 | 70 | S | S | [BernoulliモデルでLRT・Wald・Scoreを比較する](core/70_bernoulli_lrt_wald_score.md) | ◎・修正済（対数の数値評価不要） |
| 03 | 63 | S | A | [Neyman–Pearson・単調尤度比・UMP](core/63_neyman_pearson_ump.md) | 表 |
| 04 | 41 | S | A | [一様分布の完備十分統計量・Lehmann–Scheffé](core/41_uniform_complete_sufficient_umvu.md) | ◎ |
| 05 | 55 | S | A | [指数分布の十分性・完備性・UMVU](core/55_exponential_complete_sufficient_umvu.md) | ◎ |
...
| 09 | 62 | S | S | [多項分布LRTとPearson適合度](core/62_multinomial_lrt_pearson.md) | ◎・修正済（対数は数値化不要） |
| 10 | 78 | S | A | [Gauss–Markov・BLUE](core/78_gauss_markov_blue.md) | ◎ |
| 11 | 80 | S | S | [一般線形仮説・partial F](core/80_general_linear_hypothesis_partial_f.md) | ○ |
| 12 | 75 | S | A | [回帰係数のMLE・Fisher情報・検定・検出力](core/75_regression_mle_fisher_power.md) | 表・修正済（CDFの数値評価不要） |
| 13 | 48 | S | A | [Student化とt信頼区間](core/48_student_t_confidence_interval.md) | 表・○ |
| 14 | 45 | S | A | [カイ二乗ピボットによる分散・標準偏差CI](core/45_chisq_variance_confidence_interval.md) | 表・○ |
| 15 | 72 | S | A | [正規2標本のF検定・pooled t](core/72_two_sample_f_pooled_t.md) | 表・○ |
| 16 | 43 | S | A | [二項モデル：十分性・MLE・MSE・縮小](core/43_binomial_sufficiency_shrinkage.md) | ◎ |
| 17 | 44 | S | A | [台が母数に依存する非正則MLE・不偏化](core/44_uniform_nonregular_mle.md) | ◎ |
| 18 | 57 | S | A | [逆分散重み付き推定・BLUE・MLE・CRLB](core/57_inverse_variance_blue_mle.md) | ○ |
...
| 22 | 49 | S | A | [Poisson MLE・Fisher情報・信頼区間](core/49_poisson_mle_fisher_ci.md) | 表・○ |
...
| 29 | 77 | S | A | [重回帰・VIF・欠落変数バイアス・MSE](core/77_multiple_regression_vif_omitted_bias.md) | ◎ |
...
| 32 | 66 | A | A | [制約付きMLE・尤度比検定](core/66_constrained_mle_lrt.md) | ◎・修正済（対数の数値評価不要） |
...
| 38 | 4 | A | B | [カイ二乗MGF・再生性・Beta接続](core/04_chisq_mgf_beta.md) | ◎ |
...
| 43 | 53 | A | B | [Poisson母数推定：不偏性・一致性・MSE](core/53_poisson_unbiased_consistent_mse.md) | ◎ |
...
| 48 | 97 | A | A | [幾何・負の二項：待ち時間・PGF・無記憶性](core/97_geometric_negative_binomial_pgf.md) | ◎ |
...
| 03 | 13 | A | A | [指数分布MGF・指数傾斜](standard/13_exponential_mgf_tilting.md) | ◎ |
...
| 09 | 21 | A | A | [多項分布・共分散行列・多変量CLT](standard/21_multinomial_covariance_mvn_clt.md) | ◎ |
...
| 16 | 52 | A | A | [Pareto MLE・有限標本バイアス・効率](standard/52_pareto_mle_bias_efficiency.md) | ◎ |
...
| 22 | 68 | A | A | [適合度LRT・Pearson・自由度](standard/68_gof_lrt_pearson.md) | ◎・修正済（対数の数値評価不要） |
...
| 実装順 | 100 No. | 演習価値 | 難度 | 主題 | 手計算監査 |
| ---: | ---: | :---: | :---: | --- | --- |
| 01 | 17 | A | S | [二項PGF・Chernoff型評価](advanced/17_binomial_pgf_chernoff.md) | ◎・修正済（対数の数値評価不要） |
...
| 11 | 51 | A | S | [位置母数付き指数・非正則2母数MLE](advanced/51_shifted_exponential_nonregular_mle.md) | ◎ |
| 12 | 61 | A | S | [2成分Poisson混合・EM](advanced/61_poisson_mixture_em.md) | ◎・修正済（収束までの反復計算不要） |
| 13 | 64 | S | S | [母平均の両側UMPU](advanced/64_two_sided_umpu_mean.md) | 表 |
