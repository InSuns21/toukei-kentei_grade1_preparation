# Standard 23 標本相関係数の漸近分布とフィッシャー z 変換
...
> **フィッシャー z 変換が分散安定化変換として導かれる理由**にある。

---

## 詳細解答

この問題で最も重要なのは、フィッシャーの $z$ 変換を最初から既知の公式として使うことではない。
...
つまりフィッシャーの $z$ 変換は、突然与えられる技巧ではなく、
...
フィッシャー z 変換の本質は、**相関係数を正規化する公式**というより、**漸近分散を安定化する変換**にある。
...
- $(X^2,Y^2,XY)$ の必要な4次モーメントと分散共分散行列を導出: 5点
- 多変量中心極限定理・Delta 法から $r$ の漸近分散 $(1-\rho^2)^2$ を導出: 5点
- 分散安定化条件から $g'(\rho)=1/(1-\rho^2)$ を立て、フィッシャー z 変換を導出: 6点
