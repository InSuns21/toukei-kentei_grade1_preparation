...
| 02 | 12 | A | A | [カイ二乗・Cauchy・逆関数法](12_chisq_cauchy_inverse_transform.md) |
| 03 | 13 | A | A | [指数分布MGF・指数傾斜](13_exponential_mgf_tilting.md) |
...
| 09 | 21 | A | A | [多項分布・共分散行列・多変量CLT](21_multinomial_covariance_mvn_clt.md) |
...
| 14 | 47 | A | A | [二項比率Wald区間・被覆確率](47_binomial_wald_coverage.md) |
| 15 | 50 | A | A | [二項2母数モーメント法・識別](50_two_parameter_binomial_moments.md) |
| 16 | 52 | A | A | [Pareto MLE・有限標本バイアス・効率](52_pareto_mle_bias_efficiency.md) |
...
| 32 | 96 | A | A | [Weibull・生存関数・ハザード](96_weibull_survival_hazard.md) |
