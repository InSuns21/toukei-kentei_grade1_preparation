# Standard 02 Cauchy分布・逆関数法・反転変換
...
すなわち、標準Cauchy分布は逆数変換 $x\mapsto1/x$ に対して分布が変わらない。この性質は、標準Cauchy分布が正規変数の比 $Z_1/Z_2$ として表せることから、分子と分母を入れ替えても同じ分布になることとも整合する。
