...
- **1級での扱い**：Chernoff bound や KL ダイバージェンスの公式を暗記していることを前提にしない。問題文で定義された量まで自力で導くことを主眼とする
...
この形まで導いて初めて、得られた上界を**Chernoff型上界**と呼べる。ここでKLダイバージェンスは外から突然持ち込んだ公式ではなく、指数型上界を最適化した結果として自然に現れている。
