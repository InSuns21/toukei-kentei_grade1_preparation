...
- STO5 の direct prerequisite は STO2・STO4 とした。STO2 の離散時間 bounded optional sampling を dyadic stopping-time approximation で連続時間へ持ち上げ、bounded stopping による martingale の停止を章内証明した。
