...
- STO8 の direct prerequisite は STO3・STO4・STO5・STO6・STO7・F0-00D2C とした。空間連続性で Kolmogorov--Chentsov、reflection law で reflection principle / Levy characterization、高次 moment で BDG、occupation formula で Tonelli / Fubini を実際に使うためであり、旧 SP 系列は prerequisite / proof dependency にしない。
