...
- TSA6 の direct prerequisite は TSA1 と P3-03 に限定した。TSA1 の最良線形予測・イノベーションと、P3-03 の多変量正規分布・条件付き分布を canonical dependency として再利用する。TSA4 の ARMA は接続先として stable anchor を参照するが、Kalman 再帰の証明依存には置かない。
