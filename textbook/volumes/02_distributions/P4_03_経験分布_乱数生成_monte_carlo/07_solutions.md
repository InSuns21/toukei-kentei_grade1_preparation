...
6. チェビシェフの不等式だけで
   ...
   =48407.12\ldots.$$
   従って最小整数は $N=48408$。中心極限定理による9299より大きいのは、チェビシェフの不等式が分布形を使わない保守的な保証だからである。
...
$1.96\sqrt{0.242036/N}\le0.01$ より $N\ge9299$。チェビシェフの不等式だけなら $0.242036/\{N(0.01)^2\}\le0.05$ より $N\ge48408$ であり、分布形を使わない分だけ保守的である。
