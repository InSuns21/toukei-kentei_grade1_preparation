...
です。従って [重根の形式微分判定](../FLD2/index.md#thm-fld2-repeated-root) により $f_n$ は重根を持ちません。
...
$\mathbb F_2[x]$ のモニック既約二次多項式は

$$
x^2+x+1
$$

だけです。もし $f$ が一次因子を持たずに可約なら、二つの既約二次多項式の積でなければならないので
...
2. [既約多項式から体を作る構成](../FLD1/index.md#thm-fld1-irreducible-quotient-root)により $K$ は体です。
