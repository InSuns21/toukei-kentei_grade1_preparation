...
KKT乗数表示は、この normal cone を制約勾配で表現する段階です。ただし標準通読では、その前に G2 で **共役関数・Fenchel--Young 等号条件・双対ギャップ**を入れます。すると KKT の stationarity が「双対ギャップ0の等号条件」としても見えるようになります。
...
**次：[F0-00G2 Fenchel共役・Fenchel--Young・双対](../F0_00G2_Fenchel共役_Fenchel_Young_双対/index.md)**
