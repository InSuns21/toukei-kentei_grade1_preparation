...
[GEO11](../GEO11/index.md) では、Euclid 空間に埋め込まれた超曲面について、第一基本形式から内在曲率が読み取れることを見ました。そこで残る問いは明確です。
...
この証明でパラコンパクト性が間接的に効いています。GEO4 で「滑らかな多様体はパラコンパクト」から 1 の分割を構成したため、局所内積を大域的に貼れました。
...
連結な滑らかな多様体は局所的に弧状連結なので、任意の二点は区分的滑らかな曲線で結べます。従って長さの下限を取れます。
