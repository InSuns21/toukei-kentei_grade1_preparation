...
本章では切断跡を「最短性が壊れる場所」として定義するところまでに留め、指数写像の特異性や共役点との精密な関係は GEO17 へ送ります。
...
その後 GEO17 で変分公式・Jacobi 場・共役点を導入すると、本章で入口だけ定義した切断跡 と「なぜ測地線が最短でなくなるのか」を、変分の立場からさらに精密に解析できます。
