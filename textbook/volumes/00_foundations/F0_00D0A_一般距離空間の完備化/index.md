...
#### 解答
##### 詳細解答
$[0,1]$ は完備な $\mathbb R$ の閉部分集合なので完備。包含写像 $(0,1)\hookrightarrow[0,1]$ は等長である。また0は $1/n$、1は $1-1/n$ で近似でき、内部点は自分自身で近似できるので $(0,1)$ は $[0,1]$ に稠密。従って[完備化の一意性](#thm-f0-00d0a-uniqueness)から
$$
\widehat{(0,1)}\cong[0,1].
$$
