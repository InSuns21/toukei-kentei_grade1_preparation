...
は複素数値の解です。ODE2 の[定係数斉次方程式の基本解系](../ODE2/index.md#thm-ode2-constant-coefficient)で用いた $e^{i\theta}=\cos\theta+i\sin\theta$ を使うと
...
$A$ とその行列指数が可換なので斉次部分が相殺しました。成分ごとに[微積分学の基本定理I](../RA4/index.md#thm-ra4-ftc1)を使えば
...
と分けます。$I$ と $J$ は可換で $J^2=-I$ なので、行列指数の級数を偶数冪と奇数冪に分けると
