...
左端点列 $(a_k)$ は単調増加で上に有界なので、[実数の上限性質](../F0_00A1B_実数の上限性質_Archimedes性/index.md#thm-f0-00a1b-lub)により
...
### 4.1 具体例：$\mathbb R^p$ では「閉かつ有界」で判定できる
...
したがって $x\in K$ です。F0-00Bの[閉集合の点列特徴付け](../F0_00B_距離空間_開集合_閉集合_収束/index.md#thm-f0-00b-01)より $K$ は閉集合です。
...
と収束します。$K$ は閉集合なので、F0-00Bの[閉集合の点列特徴付け](../F0_00B_距離空間_開集合_閉集合_収束/index.md#thm-f0-00b-01)より

$$
x\in K.
$$

したがって $K$ は点列コンパクトです。[距離空間での同値定理](#thm-f0-00c1-01)より $K$ はコンパクトです。$\square$
<!-- proof-end -->
...
は閉かつ有界なので[Heine–Borel](#thm-f0-00c1-02)によりコンパクトです。
...
$\mathbb R$ では[Heine–Borel](#thm-f0-00c1-02)により「閉かつ有界」とコンパクトが同値です。
...
$\Delta$ は各条件 $\theta_i\ge0$ と $\sum_i\theta_i=1$ で定まる閉集合です。また $0\le\theta_i\le1$ なので有界です。[Heine–Borel](#thm-f0-00c1-02)より $\Delta$ はコンパクトです。
