...
> $$
>
> を $f$ の **レベル集合** と呼ぶ。特に $n=3$ のとき、この集合を **レベル曲面** とも呼ぶ。さらに $f\in C^1(U)$ とし、点 $p\in L_c$ で
>
> $$
> \nabla f(p)\neq0
> $$
>
> なら $p$ を正則点と呼ぶ。このとき陰関数定理により、$p$ の近くの $L_c$ は実際に二次元の $C^1$ 級曲面になり、これを **正則レベル曲面**（一般の $n$ では正則レベル集合）と呼ぶ。
<!-- formal-statement-end -->
