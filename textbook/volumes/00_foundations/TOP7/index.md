# TOP7 標準位相 VII：一様構造・一様連続・Cauchy 構造
...
この章では、[TOP6 の filter](../TOP6/index.md#def-top6-filter) と [全有界性](../TOP6/index.md#thm-top6-total-bounded-cauchy-subsequence) を土台に、距離の「$\varepsilon$ 以内」を抽象化した **一様構造**を導入します。
...
> **位相が同じでも、一様連続性・Cauchy 性・完備性は同じとは限らない。**
