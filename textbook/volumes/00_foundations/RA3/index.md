...
高校微積分で使った公式を、存在定理としての平均値定理から組み直します。
...
[最大最小値定理](../F0_00C2_コンパクト性の応用_最大最小_最近点/index.md#thm-extreme-value) により $f$ は $[a,b]$ で最大値・最小値を取ります。定数関数でなければ少なくとも一方の極値を内部点 $c$ で取り、その点で左右の差商の符号を比べると $f'(c)=0$ です。$\square$
<!-- proof-end -->
