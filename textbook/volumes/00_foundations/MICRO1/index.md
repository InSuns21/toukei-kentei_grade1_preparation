...
完備性と推移性により、異なる同値類どうしは一方向に比較でき、循環しません。
...
$$
C_1\prec C_2\prec\cdots\prec C_m
$$
...
各非空開区間 \(I_a\) から有理数 \(q_a\in I_a\) を一つ選ぶと、区間が互いに素なので
