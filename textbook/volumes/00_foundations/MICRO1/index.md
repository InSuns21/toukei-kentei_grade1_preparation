...
この $X$ が、この章でいう **選択集合**です。まだ価格や所得は入っていません。つまり $X$ は「そもそも比較対象にする候補の宇宙」であり、MICRO2 で価格と所得を入れて作る「実際に買える候補の集合」とは役割が違います。
...
この見方へ移ると、「好み」が幾何学になります。上位集合が丸くつながっているか、凸か、閉じているか、といった集合の性質を使って消費者問題を調べられるようになります。
