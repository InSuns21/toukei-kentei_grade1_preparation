...
$N$ を増やすと左辺の事象は単調に増えます。[下からの連続性](../F0_00D2_測度_可測関数_Lebesgue積分_Lp/index.md#thm-f0-00d2-01)により $N\to\infty$ とすると
...
### F0-00P5A-B01 tail部分和からCauchy性を再構成する
...
$N$ を増やすと左辺の事象は単調増加するので、[下からの連続性](../F0_00D2_測度_可測関数_Lebesgue積分_Lp/index.md#thm-f0-00d2-01)により
