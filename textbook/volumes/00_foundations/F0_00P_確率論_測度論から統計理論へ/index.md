...
- P2のRadon--Nikodym定理は、定理を**使うだけ**ならD2系の測度論を前提に読めるが、この教材で掲載した完全証明は [F0-02C2 線形汎関数・双対空間・Riesz](../F0_02C2_線形汎関数_双対空間_Riesz/index.md) のRiesz表現定理を使う。そのためP2のchapter metadataにはF0-02C2も前提として記録している。
