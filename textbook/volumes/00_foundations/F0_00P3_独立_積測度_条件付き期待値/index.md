...
逆にこの等式が a.e. で成り立てば、全 Borel 集合で同時分布と積測度の値が一致するので、[独立性と積測度の同値](#thm-f0-00p3-independence-product-law)から $X,Y$ は独立です。
...
[独立性と積測度の同値](#thm-f0-00p3-independence-product-law)から
