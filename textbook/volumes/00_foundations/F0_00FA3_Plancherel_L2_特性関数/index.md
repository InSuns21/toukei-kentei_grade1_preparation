...
任意の $\eta>0$ に対し、[$L^2(\mathbb R)$ の平行移動連続性](../F0_00FA1_Fourier級数_直交展開/index.md#lem-f0-00fa1-translation-continuity)から $|h|<\delta$ なら $\|\tau_hf-f\|_2^2<\eta$ とできます。遠方では常に
...
であり、右辺は0へ点wise収束し $|f|^2$ に支配されるので[優収束定理](../F0_00D2B_単調収束_Fatou_優収束/index.md#thm-f0-00d2b-01)から
...
で右辺は0へ点wise収束し、$|f|^2$ に支配されます。従って[優収束定理](../F0_00D2B_単調収束_Fatou_優収束/index.md#thm-f0-00d2b-01)により $\|f_N-f\|_2\to0$ です。
