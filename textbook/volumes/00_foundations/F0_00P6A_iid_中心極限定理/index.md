...
P6で準備した特性関数と[Lévy連続性定理](../F0_00P6_特性関数_中心極限定理/index.md#thm-f0-00p6-levy-continuity)を使い、独立同分布・有限分散版中心極限定理を
...
[Levy連続性定理](../F0_00P6_特性関数_中心極限定理/index.md#thm-f0-00p6-levy-continuity)から
...
正則性条件の下で平均0・分散フィッシャー情報量を持つため、[中心極限定理](#thm-iid-clt)からスコアの漸近正規性が得られます。
