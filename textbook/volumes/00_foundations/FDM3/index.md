...
<a id="def-fdm3-grid-convergence"></a>
<!-- formal-statement-start -->
### 定義（格子収束）
...
<!-- definition-example-start: def-fdm3-global-error, def-fdm3-grid-convergence -->
### 例：最大ノルムで格子誤差を見る
...
拡散 CFL 条件が使われるのは、局所残差を大域誤差へ運ぶときです。
...
従って後退 Euler 差分法は最大ノルムでも 拡散 CFL 条件なしに縮小的である。
<!-- formal-statement-end -->
