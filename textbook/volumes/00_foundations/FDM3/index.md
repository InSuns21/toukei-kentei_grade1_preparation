...
- 離散解作用素
- どのノルムで近似するか
- well-posedness をどう置くか

を厳密に設定する必要があります。

本章では、その一般論を看板だけ掲げるのではなく、熱方程式の具体的な時間発展作用素に対して必要な方向
...
<a id="thm-fdm3-be-contraction"></a>
<!-- formal-statement-start -->
...
熱方程式の連続最大原理では、内部で新しい正の最大値を自発的に作れないという拡散の性質が現れます。
...
## 14. FDM2 の Fourier 安定性と本章の最大値原理は何が違うか
