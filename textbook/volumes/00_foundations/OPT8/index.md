...
OPT3 で学んだ劣微分・標示関数・法錐・Fermat 条件と、OPT7 の滑らかな項 $f$ に対する[降下補題](../OPT7/index.md#thm-opt7-descent-lemma)を組み合わせ、反復法と収束率まで進みます。
...
したがって[近接勾配法の劣線形収束](#thm-opt8-proximal-gradient-rate)から
