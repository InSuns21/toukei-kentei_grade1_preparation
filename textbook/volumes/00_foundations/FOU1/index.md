...
$T_N$ をそのまま積分すると、[正弦・余弦の一周期積分消去則](#thm-fou1-frequency-cancellation)により定数項以外は0です。したがって
...
$R_N:=T_N-S_Nf$ と置きます。実 Fourier 係数の定義と[正弦・余弦の一周期積分消去則](#thm-fou1-frequency-cancellation)から
...
さらに[正弦・余弦の一周期積分消去則](#thm-fou1-frequency-cancellation)により、$|S_Nf|^2$ を展開したときの異なる周波数どうしの交差項は消えます。よって
...
- 正弦・余弦を一周期積分すると、異なる整数周波数どうしの積が消えることを直接証明した。
