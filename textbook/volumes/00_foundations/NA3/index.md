...
非線形問題を毎回一つの線形問題へ置き換えるのが、ここから定義する反復法の基本発想です。

---

## 2. Jacobian 一次近似から反復式を導く
...
本章では、一変数 Newton 法を非線形連立方程式へ拡張し、その局所収束機構を行列と一次近似誤差から組み立てました。
