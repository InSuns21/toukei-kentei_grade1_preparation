...
4.
   ...
   $$
   を求めよ。
5. この値が 最高次係数が1の4次多項式の最小可能な区間上の絶対値の最大値である理由を本文の最小最大定理から説明せよ。
...
Chebyshev 最小最大定理により、これは 最高次係数が1の $n+1$ 次節点多項式の区間上の絶対値の最大値として最小可能です。
...
Chebyshev 節点は $[-1,1]$ 上で節点多項式の区間上の絶対値の最大値を最小にし、等間隔高次補間で現れる Runge 現象を理解するための基準になります。
