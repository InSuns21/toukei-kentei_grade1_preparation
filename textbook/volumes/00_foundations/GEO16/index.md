...
最後の対交換対称性は、正規座標における二階微分表示から確認できます。
...
> 一つの内積空間上の二つの Riemann 型4階テンソル $A,B$ が、全ての2次元部分空間で同じ断面曲率を与えるとする。
>
> このとき
>
$$
...
最後に第一 Bianchi 恒等式を使うと同じ量が3回足されて0になるため、その量自身が0になります。
...
1. 第二基本形式を求めよ。
2. Gauss 方程式から Riemann 曲率テンソルを求めよ。
3. 断面曲率を求めよ。
...
9. 定断面曲率 $c$ なら
   ...
   $$
   となること。
10. Gauss 方程式により、Euclid 超曲面の主方向平面では
    $$
...
これにより、GEO15 で導入した切断点・最短性の喪失と、本章の曲率が「共役点」という機構を通じて結び付きます。
