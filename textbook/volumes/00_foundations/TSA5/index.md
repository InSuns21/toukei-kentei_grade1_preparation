...
[F0-00P6A の 独立同分布有限分散中心極限定理](../F0_00P6A_iid_中心極限定理/index.md)より
...
2. $E|Z_0|<\infty$ と $\sum_j|\psi_j|<\infty$ から
   ...
   iid 経路シフトは混合的、従ってエルゴード的です。因果写像は時間シフトと可換なので、$X$ の不変事象を 独立同分布経路空間へ引き戻すと 独立同分布シフトの不変事象になります。その確率は 0 または 1 です。
