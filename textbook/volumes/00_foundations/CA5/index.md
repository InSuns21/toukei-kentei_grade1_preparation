...
解析接続とモノドロミーは [CA8 の被覆に沿う解析接続](../CA8/index.md#thm-ca8-covering-analytic-continuation)で幾何的に読み直す。CA5 では芽を経路に沿って有限個の重なりで継続したが、CA8 ではその「どの枝を追っているか」を被覆空間のシートと経路持ち上げで表す。
