...
と書けます。$H'(y)=1/h(y)$ を満たす関数 $H$ を取れば連鎖律から
...
[積分因子法](#thm-ode1-linear-ivp) で $e^t$ を掛ければ
...
$q<1$ より $(1-q)\|u-v\|_\infty\le0$。左辺の量は非負なので $\|u-v\|_\infty=0$、従って $u=v$ です。$\square$
<!-- proof-end -->
...
[積分因子法](#thm-ode1-linear-ivp) により $e^t$ を掛けると
