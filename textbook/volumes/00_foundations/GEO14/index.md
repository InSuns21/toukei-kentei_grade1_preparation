...
最後に、任意の十分近い二点を一意な最短曲線で結べる近傍まで構成します。[GEO15](../GEO15/index.md) の Hopf--Rinow の定理では、本章の局所結果を大域へ押し広げます。
...
測地線はまず **局所的**に最短です。大域的にいつまで最短でいられるかは、[GEO15](../GEO15/index.md) の完備性・切断跡の入口と GEO17 の共役点へつながります。
