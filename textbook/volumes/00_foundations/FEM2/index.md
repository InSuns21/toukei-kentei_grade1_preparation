...
p(x,y)
=
c_1+(c_2-c_1)x+(c_3-c_1)y
}
$$

であり、三つの頂点値は $P_1(\widehat K)$ の関数を一意に決めます。

よって

$$
(\widehat K,P_1(\widehat K),\{N_1,N_2,N_3\})
$$
...
また $v_h$ は大域的に連続なので、$E$ 上の trace は両側から同じです。
