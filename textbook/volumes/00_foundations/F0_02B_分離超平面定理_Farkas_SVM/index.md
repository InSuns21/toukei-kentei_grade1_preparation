...
> **アーカイブ**
>
> このページの canonical な内容は [OPT2](../OPT2/index.md) へ移管済みです。stable anchor と過去リンクの後方互換性のためファイル自体は保持しますが、読者向け索引・標準通読には掲載しません。
...
SVMの「正負クラスの凸包」「最大マージン」「双対変数の幾何」は独立した応用サイクルなので、後続の [RKHS4](../RKHS4/index.md) で一つの最大マージン学習サイクルとして扱います。
...
という閉有界集合の中で考えればよく、有限次元の[Heine--Borel](../F0_00C1_コンパクト性_点列コンパクト性_Heine_Borel/index.md#thm-f0-00c1-02)によりコンパクトです。
...
<!-- solution-start -->
#### 詳細解答
$y=(1,-1)^T$ と取ると $A^Ty=1-1=0\le0$。一方 $b^Ty=1+1=2>0$。従って[Farkasの補題](#thm-farkas)により非負解は存在しない。
#### 本番答案
