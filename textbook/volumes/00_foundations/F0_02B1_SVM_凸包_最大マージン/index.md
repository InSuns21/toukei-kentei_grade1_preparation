...
> **アーカイブ**
>
> このページの canonical な内容は [RKHS4](../RKHS4/index.md) へ移管済みです。stable anchor と過去リンクの後方互換性のためファイル自体は保持しますが、読者向け索引・標準通読には掲載しません。
...
したがって [F0-00C1](../F0_00C1_コンパクト性_点列コンパクト性_Heine_Borel/index.md) の「連続像はコンパクト」が使えます。
...
ただし「Hilbert空間」「RKHS」「なぜkernelが内積になるのか」を数学的に理解するには、[F0-02C 関数解析補講ロードマップ](../F0_02C_関数解析_制約想定_RKHS/index.md) からC1→C1A→C2→C3→C3A→C4→C4A→C5→C5A→C6→C6A→C7→C7Aへ進んでください。
