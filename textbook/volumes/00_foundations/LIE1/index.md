...
二つの係数が定数の滑らかなベクトル場の係数は全て定数なので、[Lie 括弧の座標公式](../GEO5/index.md#thm-geo5-bracket-coordinate)から
...
[F-関連性は Lie 括弧で保たれる](#lem-lie1-related-bracket) ことにより、$\Phi$-関連性は Lie 括弧を取っても保たれます。
...
[Lie 括弧の座標公式](../GEO5/index.md#thm-geo5-bracket-coordinate)を一次元で用いると
