...
双対関数がなぜ主問題の下界になるか、不等式制約の乗数がなぜ非負なのかまで戻りたい場合は [F0-02 制約付き最適化・双対問題・KKT条件](../../00_foundations/F0_02_制約付き最適化_双対_KKT/index.md) を参照してください。
...
一般のKKT条件、activeな制約、弱双対性・強双対性まで含めた説明は [F0-02 制約付き最適化・双対問題・KKT条件](../../00_foundations/F0_02_制約付き最適化_双対_KKT/index.md) を参照してください。
