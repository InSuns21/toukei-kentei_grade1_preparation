...
集合・写像の基礎から、群・環・加群・体へ進む学部標準の抽象代数系列です。現在は群論の第2講まで実装済みです。
...
GRP1 で群・部分群・巡回群・置換群・Cayley の定理を構成し、GRP2 で準同型、核・像、剰余類、Lagrange の定理、正規部分群、商群、第一・第二・第三同型定理、対応定理までを閉じます。次は GRP3 で群作用・軌道・安定化群・共役へ進みます。
