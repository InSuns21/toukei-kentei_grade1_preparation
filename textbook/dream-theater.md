...
集合・写像の基礎から、群・環・加群・体へ進む学部標準の抽象代数系列です。群論の主線 GRP1--GRP4 を閉じ、環論の RNG3 まで実装済みです。
...
GRP1--GRP4 で群・商構造・群作用・Sylow 理論までの有限群論主線を閉じます。RNG1--RNG2 で環・イデアル・商環・素/極大イデアル・中国剰余定理を構成し、RNG3 では整除・最大公約元・Euclid の互除法から Euclid 整域・PID・UFD の主線を核心証明付きで閉じます。次の抽象代数主線は RNG4 の多項式環・Gauss の補題・既約多項式です。
