...
3. [F0-02A KKT条件の導出・接錐・polar・Farkas](textbook/volumes/00_foundations/F0_02A_KKT条件の導出_接錐_polar_Farkas/index.md)
4. [F0-02B1 SVM・凸包・最大マージン](textbook/volumes/00_foundations/F0_02B1_SVM_凸包_最大マージン/index.md)

`F0-02` ではKKTをまず使える形でつかみ、`F0-02B` で分離超平面とFarkasを準備してから、`F0-02A` でKKTの導出へ戻ります。SVMの凸包幾何だけを見るなら `F0-02B → F0-02B1` と短絡できます。
...
3. [F0-02C1A Hilbert射影定理・直交分解](textbook/volumes/00_foundations/F0_02C1A_Hilbert射影定理_直交分解/index.md)
4. [F0-02C2 線形汎関数・双対空間・Riesz](textbook/volumes/00_foundations/F0_02C2_線形汎関数_双対空間_Riesz/index.md)
5. [F0-02C6 Hahn–Banach・汎関数拡張](textbook/volumes/00_foundations/F0_02C6_Hahn_Banach_分離定理/index.md)
6. [F0-02C6A 分離定理・Minkowski functional・Farkas](textbook/volumes/00_foundations/F0_02C6A_分離定理_Minkowski_Farkas/index.md)
...
13. [F0-02C7 RKHS・再生核・Moore–Aronszajn](textbook/volumes/00_foundations/F0_02C7_RKHS_再生核_representer_kernel_SVM/index.md)
14. [F0-02C7A representer theorem・kernel SVM](textbook/volumes/00_foundations/F0_02C7A_representer_kernel_SVM/index.md)

RKHSだけを先に知りたい場合は、数学的には `F0-02C1 → C1A → C2 → C7` まで短絡できます。kernel SVMまで行く場合は、そこに `C3` と有限次元側の `F0-02B1` が合流します。
