...
集合・写像の基礎から、群・環・加群・体へ進む学部標準の抽象代数系列です。現在は入口となる群論の第1講を実装済みです。

1. [GRP1 群・部分群・巡回群・置換群](textbook/volumes/00_foundations/GRP1/index.md)

GRP1 では群公理、部分群判定、生成部分群、元の位数、巡回群の部分群構造、直積、対称群・交代群、二面体群、Cayley の定理までを扱います。剰余類・Lagrange の定理・商群はこの講へ詰め込まず、後続講へ分離します。
