...
3. GRP3 群作用・軌道・安定化群・共役
4. GRP4 Cauchy の定理・Sylow の定理・有限群への応用
...
GRP1「群・部分群・巡回群・置換群」と GRP2「準同型・剰余類・正規部分群・商群」は 2026-09-23 に実装完了。
...
GRP2 完了により LIE1 の群論 prerequisite は満たされた。抽象代数系列を続行する場合は GRP3 へ進み、GRP3 完了後に LIE2 / LIE4 に必要な群作用・共役も揃う。一方、抽象代数系列そのものは GRP4--RNG1--RNG4--MOD1--MOD2--FLD1--FLD5 まで進め、群・環・体の学部標準コアを独立に完結させる。
