...
GRP1「群・部分群・巡回群・置換群」、GRP2「準同型・剰余類・正規部分群・商群」、GRP3「群作用・軌道・安定化群・共役」は 2026-09-23 に実装完了。
...
GRP3 完了により LIE2 / LIE4 に必要な群作用・共役の prerequisite も満たされた。Lie 系列は GRP4 を待たず開始できる。一方、抽象代数系列を続行する場合は GRP4 で有限群論を閉じ、その後 RNG1--RNG4--MOD1--MOD2--FLD1--FLD5 へ進み、群・環・体の学部標準コアを独立に完結させる。
