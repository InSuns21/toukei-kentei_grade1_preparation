...
GRP1「群・部分群・巡回群・置換群」、GRP2「準同型・剰余類・正規部分群・商群」、GRP3「群作用・軌道・安定化群・共役」、GRP4「Cauchy の定理・Sylow の定理・有限群への応用」、RNG1「環・環準同型・イデアル・商環」は 2026-09-23 に実装完了。Phase A の群論主線を閉じ、Phase B の環論へ入った。
...
RNG1 で環・環準同型・イデアル・商環・環の第一同型定理を canonical に構成したため、RNG2 はその商環構造を再利用して素イデアル・極大イデアルを商環の整域性・体性から特徴付け、中国剰余定理へ進む。GRP4 は後続 FLD5 の有限群論側 prerequisite として独立に再利用する。
