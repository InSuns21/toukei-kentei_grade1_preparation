...
1. GRP1 群・部分群・巡回群・置換群
2. GRP2 準同型・剰余類・正規部分群・商群
...
GRP2 まで終えれば LIE1、GRP3 まで終えれば LIE2 / LIE4 へ分岐できる。一方、抽象代数系列そのものは GRP4--RNG1--RNG4--MOD1--MOD2--FLD1--FLD5 まで進め、群・環・体の学部標準コアを独立に完結させる。
