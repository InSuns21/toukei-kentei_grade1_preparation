...
**現在地（2026-09-22）**：CA9 本文・演習・詳細解答・stable anchor・knowledge/glossary・reader-facing index は実装済み。次は validation / pedagogy audit と PR / merge を完了し、その後 Phase 4 の CA10「無限積・Weierstrass 因数分解・Mittag--Leffler」へ進む。
