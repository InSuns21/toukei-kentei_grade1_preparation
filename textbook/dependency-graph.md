...
OPT2 射影・支持超平面・分離・Farkas ───────────────┐                                                                                                      │
OPT12 二次計画・錐計画入門 ─────────────────────┴→ RKHS4 最大マージンとハードマージン SVM ───────────────────────────────┴→ RKHS5 ソフトマージン・ヒンジ損失・カーネル SVM

F0-00C1 Heine--Borel・コンパクト性 ───────────────┐
OPT2 閉凸集合への最近点射影 ──────────────────────┴→ FIX1 Sperner の補題・Brouwer 不動点定理
F0-00C1 コンパクト性・点列コンパクト性 ────────────┐
FIX1 不動点 ───────────────────────────────────────┴→ FIX2 集合値写像・対応
FIX2 対応・半連続性 ───────────────────────────────→ FIX3 Berge 最大値定理・Kakutani 不動点定理
OPT1 凸集合・準凹関数 ───────────────────────────────→ MICRO1 選好・効用・凸性
F0-00C2 最大最小・コンパクト性 ───────────────────────┐
MICRO1 選好・効用・凸性 ──────────────────────────────┼→ MICRO2 消費者最適化・需要
OPT5 Lagrange 双対・Slater 条件・KKT ────────────────┘
