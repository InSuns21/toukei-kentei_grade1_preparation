...
GRP3 は GRP2 を直接 prerequisite とする。群作用と対称群への準同型の対応、軌道・安定化群、軌道分割、$G/G_x\to Gx$ の自然な全単射、軌道・安定化群公式を証明する。共役作用では共役類・中心・中心化群を構成し、類等式から非自明な有限 $p$-群の中心非自明性まで閉じる。GRP4 はこの作用と数え上げを再利用して Cauchy・Sylow 理論へ進む。
