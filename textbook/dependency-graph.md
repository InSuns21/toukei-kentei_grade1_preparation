...
GEO10 は GEO3・VC3・LA5 を直接 prerequisite とする。GEO3 の超曲面としての部分多様体構造、VC3 の局所パラメータ表示・法線計算、LA5 までの有限次元内積・スペクトル理論を接続し、曲線の Frenet 理論、第一・第二基本形式、形作用素の自己共役性、主曲率、Gauss 曲率・平均曲率までを担当する。形作用素は $S=-dN$ の符号規約で統一する。
