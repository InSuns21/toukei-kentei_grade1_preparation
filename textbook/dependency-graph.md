...
GRP1 は F0-00A の集合・直積集合・写像・全単射・合成写像を直接 prerequisite とする。群・可換群、部分群と部分群判定、生成部分群、元の位数、巡回群とその部分群構造、直積群、対称群・交代群、二面体群を構成し、左移動による Cayley の定理までを核心証明付きで閉じる。剰余類・Lagrange の定理・正規部分群・商群・同型定理は GRP1 へ逆輸入せず、後続講で扱う。
