...
GRP2 は GRP1 を直接 prerequisite とする。群準同型・群同型、核・像、左右剰余類・指数、Lagrange の定理、正規部分群、商群を構成し、商の積が代表元によらず定まることと正規性の同値、第一・第二・第三同型定理、対応定理までを核心証明付きで閉じる。GRP3 はここで得た剰余類・指数・準同型を再利用して群作用・軌道・安定化群・共役へ進む。
