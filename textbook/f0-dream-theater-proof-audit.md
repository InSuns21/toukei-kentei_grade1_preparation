...
教材密度・具体例・演習については [DREAM THEATER 教材密度・例題・演習監査](f0-dream-theater-content-exercise-audit.md)、一講義の大きさについては [DREAM THEATER 講義粒度・分割監査](f0-dream-theater-granularity-audit.md) を併用します。
...
章ごとの最小 `prerequisites` と、標準通読順は区別します。
...
で一つの学習サイクルを閉じます。演習フォーマットの残件は教材密度監査側で追跡します。
