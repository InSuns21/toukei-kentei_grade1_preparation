...
### TODO-P0-D2-01：Borel σ代数を初出前に定義
...
### TODO-P0-D2-02：積σ代数・積測度をTonelli/Fubiniの前に定義
...
### TODO-P0-D2-03：Lebesgue測度の存在をどこで受け入れるか明記
...
### TODO-P0-C1-01：`C([0,1])` のBanach性で使う一様極限定理を前章へ接続
...
現在は **監査・計画段階**。次の実装は Batch 0 から順に行う。
