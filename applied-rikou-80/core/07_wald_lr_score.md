...
漸近的一致は対数尤度の局所2次展開で確認できる。$H_0$ の下で $\hat p-p_0=O_p(n^{-1/2})$ であり、スコア方程式を $p_0$ の周りで展開すると

$$
0=U(\hat p)
=U(p_0)+\ell''(p_0)(\hat p-p_0)+o_p(\sqrt n).
$$

また

$$
-\frac1n\ell''(p_0)\xrightarrow{p}I_1(p_0)
$$

なので、$I_n(p_0)=nI_1(p_0)$ とおけば
