...
$$
\boxed{LCL_p\approx0.0038,\quad UCL_p\approx0.0962}.
$$

### 2. np管理図

中心線は $n\bar p=10$。標準偏差は

$$
\sqrt{n\bar p(1-\bar p)}=\sqrt{9.5}\approx3.082.
$$

したがって

$$
\boxed{LCL_{np}\approx0.75,\quad UCL_{np}\approx19.25}.
$$
