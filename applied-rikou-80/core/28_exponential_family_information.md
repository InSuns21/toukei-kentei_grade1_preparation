...
3. $\theta$ に関する1標本フィッシャー情報量を求めよ。
4. ポアソン$(\mu)$ を正準指数型分布族として表し、正準母数、$b(\theta)$、平均、分散を確認せよ。
...
- (4) ポアソン確率質量関数を指数型分布族の形へ書き換え、平均・分散を確認: 4点
