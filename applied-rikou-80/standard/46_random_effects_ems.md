...
$$
E[平均二乗誤差]=\sigma^2,\qquad E[MS_A]=\sigma^2+n\sigma_A^2.
$$

したがってモーメント推定量は

$$
\hat\sigma_A^2=\frac{MS_A-平均二乗誤差}{n},\qquad \hat\sigma^2=平均二乗誤差.
$$
...
群内共分散 $\sigma_A^2$、級内相関係数 $=\sigma_A^2/(\sigma_A^2+\sigma^2)$。期待平均平方から $\hat\sigma_A^2=(MS_A-平均二乗誤差)/n$。変量効果の主対象は個別水準差でなく分散成分。
