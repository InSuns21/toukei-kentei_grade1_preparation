...
という過分散があると、実際のスコアのばらつきはポアソンモデルが想定するより大きい。ポアソン分散をそのまま使うと、データの変動を小さく見積もるため
...
ポアソンモデルは $\operatorname{Var}(Y_i)=\mu_i$ を仮定するため、実際に過分散があると標準誤差を過小評価する。
