...
直列系は $R_s=e^{-(\lambda_A+\lambda_B)t}$、平均故障時間は $1/(\lambda_A+\lambda_B)$、原因A確率は $\lambda_A/(\lambda_A+\lambda_B)$。並列系は $R_p=1-(1-e^{-\lambda_A t})(1-e^{-\lambda_B t})$、同率なら平均故障時間 $3/(2\lambda)$。
