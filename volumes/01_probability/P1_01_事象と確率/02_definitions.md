...
試行で起こり得る結果全体を標本空間 $\Omega$ と呼びます。$\Omega$ の部分集合のうち、確率を割り当てるものを事象と呼び、その全体 $\mathcal F$ は次を満たす $\sigma$-加法族とします。したがって一般には「$A\subset\Omega$」だけでは事象とは限らず、$A\in\mathcal F$ が必要です。有限標本空間では、特に断らない限り $\mathcal F=2^\Omega$ とします。
